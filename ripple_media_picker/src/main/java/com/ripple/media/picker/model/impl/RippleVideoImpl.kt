...
class RippleVideoImpl : RippleVideoModel {
    ...
    override fun toString(): String {
        return "RippleVideoImpl(parentPath='$parentPath', path='$path', dateModified=$dateModified, dateAdded=$dateAdded, size=$size, title='$title', displayName='$displayName', height=$height, width=$width, duration=$duration, type='$type', isCheck=$isCheck)"
    }

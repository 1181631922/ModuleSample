...
@JvmOverloads
fun View.showBottomDialog(layoutId: Int, dismissOutside: Boolean = true, onDismiss: SuccessLambda<RippleDialog> = null): Pair<View, RippleDialog> {
    val mContext = context
    return mContext.showBottomDialog(layoutId, dismissOutside, onDismiss)
}

@JvmOverloads
fun Activity.showBottomDialog(layoutId: Int, dismissOutside: Boolean = true, onDismiss: SuccessLambda<RippleDialog> = null): Pair<View, RippleDialog> {
    val context = baseContext
    return context.showBottomDialog(layoutId, dismissOutside, onDismiss)
}

@JvmOverloads
fun Context.showBottomDialog(layoutId: Int, dismissOutside: Boolean = true, onDismiss: SuccessLambda<RippleDialog> = null): Pair<View, RippleDialog> {
...
@JvmOverloads
fun Context.showBottomDialog(contentView: View, dismissOutside: Boolean = true, onDismiss: SuccessLambda<RippleDialog> = null): RippleDialog {
    val dialog = RippleDialog(
        RippleDialogConfig.Builder()
            ...
            .build())
    if (onDismiss != null) {
        dialog.setOnDismissListener(object : RippleDialog.OnDismissListener {

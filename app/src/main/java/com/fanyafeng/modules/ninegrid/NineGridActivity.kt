...
class NineGridActivity : BaseActivity() {
    ...
    private fun initView() {
        ...
        gridView.adapter = NineAdapter(this, imageList)
...
class NineAdapter(private val context: Context, private val list: List<NineItem>) :
    NineGridView.NineGridViewAdapter(context, list) {
